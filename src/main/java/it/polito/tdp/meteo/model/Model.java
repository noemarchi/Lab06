...
public class Model {
	...
	/**
	 * Tutte le citta presenti nel database.
	 * La lista viene letta al momento della costruzione del model (vedi costruttore)
	 * @return lista delle citta presenti
	 */
	...
	{
		return dao.getUmiditaMediaCitta(mese);
	}
	 ...
	 * @return lista di città da visitare i primi 15 giorni del mese
	 */
	public List<Citta> trovaSequenza(int mese) 
	{
		...
		// carico dentro ciscuna delle leCitta
		// la lista dei rilevamenti nel mese considerato
		// e SOLO quello
		for(Citta c: leCitta)
		{
	...
	private boolean aggiuntaValida(Citta prova, List<Citta> parziale) 
	{
		...
		// nel caso generale, se ho già passato i controlli sopra, 
